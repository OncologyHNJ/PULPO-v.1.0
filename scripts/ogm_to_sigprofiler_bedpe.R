...
# bionanodir <- "/home/user/MARTA/LABO/PULPO/PULPO_v.1.1/results/DATA/Patients"
# patient_id <- "Patient-1"
# outfile <- "/home/user/MARTA/LABO/PULPO/PULPO_OpenPBTA/results/SVs/Patients/Patient-1/SigProfiler/data/SigProfilerSVdf.bedpe"
# 
